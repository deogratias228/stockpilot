      ...
      <head>
        ...
        <noscript>
          <img
            height="1"
            width="1"
            src="https://www.facebook.com/tr?id=963255906755869&ev=PageView&noscript=1"
          />
        </noscript>
      </head>
      <body
        className={`${inter.variable} font-sans antialiased bg-white text-slate-900 overflow-x-hidden`}
      >
        {children}
      </body>
    </html>
